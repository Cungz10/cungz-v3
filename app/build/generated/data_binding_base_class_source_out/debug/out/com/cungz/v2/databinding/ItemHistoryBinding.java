...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  private ItemHistoryBinding(@NonNull LinearLayout rootView, @NonNull TextView historyContent) {
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.history_content;
      TextView historyContent = ViewBindings.findChildViewById(rootView, id);
      if (historyContent == null) {
        break missingId;
      }

      return new ItemHistoryBinding((LinearLayout) rootView, historyContent);
    }
