...
public final class FragmentMapsBinding implements ViewBinding {
  ...
  private FragmentMapsBinding(@NonNull ComposeView rootView, @NonNull ComposeView composeView) {
  ...
  public static FragmentMapsBinding bind(@NonNull View rootView) {
    ...
    return new FragmentMapsBinding((ComposeView) rootView, composeView);
  }
}
